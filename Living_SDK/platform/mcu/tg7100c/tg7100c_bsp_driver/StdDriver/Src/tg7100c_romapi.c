...
__ALWAYS_INLINE
void ATTR_TCM_SECTION TG7100C_Delay_US(uint32_t cnt){
    return RomDriver_TG7100C_Delay_US(cnt);
}

__ALWAYS_INLINE
void ATTR_TCM_SECTION TG7100C_Delay_MS(uint32_t cnt){
    return RomDriver_TG7100C_Delay_MS(cnt);
}

__ALWAYS_INLINE
void* ATTR_TCM_SECTION TG7100C_MemCpy(void *dst, const void *src, uint32_t n){
    return RomDriver_TG7100C_MemCpy(dst,src,n);
}

__ALWAYS_INLINE
uint32_t* ATTR_TCM_SECTION TG7100C_MemCpy4(uint32_t *dst, const uint32_t *src, uint32_t n){
    return RomDriver_TG7100C_MemCpy4(dst,src,n);
}

__ALWAYS_INLINE
void* ATTR_TCM_SECTION TG7100C_MemCpy_Fast(void *pdst, const void *psrc, uint32_t n){
    return RomDriver_TG7100C_MemCpy_Fast(pdst,psrc,n);
}

__ALWAYS_INLINE
void* ATTR_TCM_SECTION TG7100C_MemSet(void *s, uint8_t c, uint32_t n){
    return RomDriver_TG7100C_MemSet(s,c,n);
}

__ALWAYS_INLINE
uint32_t* ATTR_TCM_SECTION TG7100C_MemSet4(uint32_t *dst, const uint32_t val, uint32_t n){
    return RomDriver_TG7100C_MemSet4(dst,val,n);
}

__ALWAYS_INLINE
int ATTR_TCM_SECTION TG7100C_MemCmp(const void *s1, const void *s2, uint32_t n){
    return RomDriver_TG7100C_MemCmp(s1,s2,n);
}
