...
#define GPIO_LED_IO         0
#define GPIO_BUTTON_IO      2
#define GPIO_BUTTON_IO_2    4
gpio_dev_t led,led1,read1;
gpio_dev_t button1;
int entry_flag = 0;
int timeout_flag = 0;
